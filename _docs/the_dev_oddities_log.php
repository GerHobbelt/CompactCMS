...
<p>In fact, the way out here is allowing everything in our backend like this (we do validate the session and counter hacking attempts through the session-based <code>authCheck()</code> anyway, so we're allowed a little flexibility here &mdash; I don't have to <em>like</em> it though):</p>
...
&lt;<span class="start-tag">div</span><span class="attribute-name"> id</span>=<span class="attribute-value">"backup-module" </span><span class="attribute-name">class</span>=<span class="attribute-value">"module"</span>&gt;
	&lt;<span class="start-tag">div</span><span class="attribute-name"> class</span>=<span class="attribute-value">"span-8 colborder"</span>&gt;
		...
		&lt;<span class="start-tag">form</span><span class="attribute-name"> id</span>=<span class="attribute-value">"create-arch" </span><span class="attribute-name">action</span>=<span class="attribute-value">"/c/admin/includes/modules/backup-restore/backup-restore.Manage.php?do=backup" </span><span class="attribute-name">method</span>=<span class="attribute-value">"post" </span><span class="attribute-name">accept-charset</span>=<span class="attribute-value">"utf-8" </span><span class="light_up_editing">class="clearfix"</span>&gt;
