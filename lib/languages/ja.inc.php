...
$ccms['lang']['system']['error_404content'] = /* BABELFISH */ "要求されたファイルが <strong>{％pagereq％} htmlが</strong> 見つかりませんでした。";
...
$ccms['lang']['system']['error_403content'] = /* BABELFISH */ "あなたはアクセスを許可されていない <strong>{％pagereq％}。htmlを</strong> 今のところ、これ。";
