...
$ccms['lang']['system']['error_templatedir'] = /* BABELFISH */ "Der Vorlagen-Verzeichnis konnte nicht gefunden werden! Stellen Sie sicher, dass es existiert und mindestens eine Vorlage enthält.";
$ccms['lang']['system']['error_write'] = "Datei hat keine Schreibberechtigung";
$ccms['lang']['system']['error_dirwrite'] = /* BABELFISH */ "Keine Schreibrechte zum Verzeichnis";
...
$ccms['lang']['system']['error_filesize_2'] = /* BABELFISH */ "Der Dateiname sollte höchstens 50 Zeichen lang sein.";
$ccms['lang']['system']['error_pagetitle'] = "Bitte einen Seitentitel von mind. 3 Zeichen eingeben.";
$ccms['lang']['system']['error_pagetitle_2'] = /* BABELFISH */ "Geben Sie bitte einen Seitentitel von 100 Zeichen oder weniger ein.";
$ccms['lang']['system']['error_subtitle'] = "Bitte einen kurzen Untertitel für die Seite erstellen.";
$ccms['lang']['system']['error_subtitle_2'] = /* BABELFISH */ "Geben Sie bitte einen kurzen Sub-Titel von 200 Zeichen oder weniger für Ihre Seite ein.";
$ccms['lang']['system']['error_description'] = "Die Beschreibung der Seite muss ist zu kurz";
$ccms['lang']['system']['error_description_2'] = /* BABELFISH */ "Geben Sie bitte eine Beschreibung von weniger als 250 Zeichen ein";
...
$ccms['lang']['system']['error_403title'] = /* BABELFISH */ "Zutritt verboten";
$ccms['lang']['system']['error_403header'] = /* BABELFISH */ "Ein 403 Fehler: Sie haben keine Berechtigung die angeforderte Datei zu sehen.";
$ccms['lang']['system']['error_403content'] = /* BABELFISH */ "Sie sind nicht berechtigt, den Zugang zum <strong>{%pagereq%}.html</strong> in diesem Moment zu erhalten.";
...
$ccms['lang']['system']['error_passshort'] = /* BABELFISH */ "Ein Passwort sollte mindestens 6 Stellen lang sein";
...
$ccms['lang']['backend']['settingssaved'] = /* BABELFISH */ "Ihre Änderungen wurden erfolgreich gespeichert.";
$ccms['lang']['backend']['must_refresh'] = /* BABELFISH */ "Bitte laden Sie die Hauptseite mittels Funktionstaste F5 um sicher zu stellen dass <strong>alle</strong> Ihre Änderungen sichbar sein.";
$ccms['lang']['backend']['itemcreated'] = /* BABELFISH */ "Die eingereichten Artikel sind erfolgreich bearbeitet.";
$ccms['lang']['backend']['fullremoved'] = /* BABELFISH */ "Das(Die) ausgewählte Element(en) ist(sind) erfolgreich gelöscht.";
$ccms['lang']['backend']['fullregenerated'] = /* BABELFISH */ "Die Thumbnails sind erfolgreich regeneriert.";
