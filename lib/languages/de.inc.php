...
$ccms['lang']['backend']['must_refresh'] = /* BABELFISH */ "Bitte stellen Sie sicher, um zu sehen, laden Sie die Hauptseite auf <strong>alle</strong> Ihre Änderungen";
$ccms['lang']['backend']['itemcreated'] = /* BABELFISH */ "Erfolgreich bearbeitet die eingereichten Artikel (s).";
$ccms['lang']['backend']['fullremoved'] = /* BABELFISH */ "Erfolgreich gelöscht das ausgewählte Element (en).";
$ccms['lang']['backend']['fullregenerated'] = /* BABELFISH */ "Erfolgreich regeneriert die Thumbnails.";
