...
$ccms['lang']['permission']['explain']	= "Use the table below to specify what minimFISH */ "Добавить фильтр для";
...
$ccms['lang']['owners']['explain'] = /* BABELFISH */ "Здесь вы можете назначить конкретные страницы собственности для отдельных пользователей. Если на странице нет cartain пользователи выбирают, каждый может изменить страницу. В противном случае только указанный пользователь был модификации прав на файл. Администраторы всегда имеют доступ ко всем файлам.";
