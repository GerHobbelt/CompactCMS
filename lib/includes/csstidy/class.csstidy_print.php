    ...
    function _print($plain = false)
    {
        ...
        if (!empty($this->import)) {
            for ($i = 0, $size = count($this->import); $i < $size; $i ++) {      
                /*
                @import statements have already had all their imports wrapped in " double quotes before we get here.

                This would've happened around line 830 in class.csstidy.php:
                  $this->sub_value_arr[] = '"' . trim($this->sub_value) . '"';
				  
				That change was added 2009-jun-08, git commit 1897649efa7fc6a2b2d7
                */
                if(substr($this->import[$i], 0, 5) === '"url(' && substr($this->import[$i], -2, 2) === ')"') {
                    $this->import[$i] = '\''.substr($this->import[$i], 5, -2).'\'';
