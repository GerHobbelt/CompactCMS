(function(win) {
	...
	var tinymce = {
		...
		minorVersion : '4.1-201103231643',

		releaseDate : '2011-xx-x',
		...
		execCommand : function(c, u, v) {
			...
			switch (c) {
				...
				case "mceAddFrameControl":
					...
					if (typeof console !== 'undefined' && console.log) console.log('tinymce.execCommand:register onunload' + (1*t.domLoaded));
					// Fix IE memory leaks
					if (tinymce.isIE) {
						function clr() {
							ed.destroy();
