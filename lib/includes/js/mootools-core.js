...
var Request = this.Request = new Class({
	...
	success: function(text, xml){
		if (typeof console !== 'undefined' && console.log) console.log("Request class: success invoked");
		this.onSuccess(this.processScripts(text), xml);
	},

	onSuccess: function(){
		if (typeof console !== 'undefined' && console.log) console.log("Request class: onSuccess invoked");
		this.fireEvent('complete', arguments).fireEvent('success', arguments).callChain();
	},

	failure: function(){
		if (typeof console !== 'undefined' && console.log) console.log("Request class: failure invoked");
		this.onFailure();
	},

	onFailure: function(){
		if (typeof console !== 'undefined' && console.log) console.log("Request class: onFailure invoked");
...
Request.JSON = new Class({
	...
	success: function(text){
		var json;
		if (typeof console !== 'undefined' && console.log) console.log("Request.JSON class: success invoked");
		try {
