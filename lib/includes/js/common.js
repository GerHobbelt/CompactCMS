	...
	initializeWindows = function()
	{
		...
		$$('a.tabs').addEvent('click', function(e)
		{
			...
			*/
			...
			{
			case "sys-perm":
				/* grid: 20x12.5 / 15 high with feedback msg */
				dims = reduce_dimensions(20*40, 15*40);
				break;
			...
			default:
				...
				if (url)
				{
					...
					{
						/* NEWS: 21 x 13 (or whichever larger height you crave */
						dims = reduce_dimensions(21*40, 13*40);
					}
